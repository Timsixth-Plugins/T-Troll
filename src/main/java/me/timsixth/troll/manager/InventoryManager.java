...
public class InventoryManager {
    ...
    public Inventory showTrollingInventory() {
        ...
        ItemStack potion = ItemUtil.createItem(new ItemStack(Material.POTION), configFile.getGuiPrefix() + " &7Gives player random potion effect");
        ItemStack glass = ItemUtil.createItem(new ItemStack(Material.GLASS), configFile.getGuiPrefix() + " &7Gives player glass block, but player can't drop it");
        ItemStack diamond = ItemUtil.createItem(new ItemStack(Material.DIAMOND), configFile.getGuiPrefix() + " &7Gives player reward from admin :)");
